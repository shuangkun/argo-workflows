This branch of Argo Workflows is maintained by DeepModeling community, which fixes some known bugs and add some features required by [dflow](https://github.com/deepmodeling/dflow).
